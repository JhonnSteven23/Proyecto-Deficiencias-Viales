...
export default function PerfilUsuarioScreen() {
  ...
  const [stats, setStats] = useState<ProfileStats>({ enviados: 0, completados: 0 });
  ...
  useEffect(() => {
    ...
    const q = query(reportesRef, where("userId", "==", profile.uid));
    ...
    const unsubscribe = onSnapshot(q, (querySnapshot) => {
      ...
      setStats({ enviados: querySnapshot.size, completados });
      setIsStatsLoading(false);
    });
    return () => unsubscribe();
  }, [profile]);
    ...
    try {
      ...
      if (newValue === true) {
        ...
        if (token) {
          ...
          Alert.alert("Permiso requerido", "Ve a ajustes y activa las notificaciones.");
        }
  ...
  const handlePermissionsLink = () => {
    Alert.alert(
      "Gestionar Permisos",
      "Para cambiar permisos (Ubicación, Cámara) ve a los ajustes de Android.",
      [
  ...
  return (
    ...
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 40 }}>
      <View style={styles.headerContainer}>
        ...
        />
        <Text style={styles.profileName}>{profile?.displayName || "Ciudadano"}</Text>
      ...
      <View style={styles.contentContainer}>
        <View style={styles.statsCard}>
          <View style={styles.statItem}>
            <Text style={styles.statValue}>{stats.enviados}</Text>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.row}>
            ...
            <View style={styles.rowTextContainer}>
              ...
              <Text style={styles.rowSubLabel}>Recibir estado de mis reportes</Text>
            </View>
            <Switch
          ...
          <View style={styles.rowNoBorder}>
            ...
            <View style={styles.rowTextContainer}>
              ...
              <Text style={styles.rowSubLabel}>Permitir acceso al GPS</Text>
            </View>
            <Switch
              trackColor={{ false: "#767577", true: "#007AFF" }}
        ...
        <View style={styles.sectionCard}>
          ...
          <TouchableOpacity style={styles.row} onPress={() => setModalSoporteVisible(true)}>
            ...
            <View style={styles.rowTextContainer}>
              ...
              <Text style={styles.rowSubLabel}>Ayuda con la aplicación</Text>
            </View>
          ...
          <TouchableOpacity style={styles.rowNoBorder} onPress={() => setModalAcercaVisible(true)}>
            ...
            <View style={styles.rowTextContainer}>
              ...
              <Text style={styles.rowSubLabel}>Versión {appConfig?.version || '1.0.0'}</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#ccc" />
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.modalText}>
            ¿Problemas con tu cuenta o reporte? Contáctanos:
          </Text>
